...
int main(void)
{
    ...
    cout << "\n#TESTE 8\n";
    insereAposCadaOcorrencia(&lista, 5, 12, 2025, Compromisso(5, 12, 2025, "CX6"));
    mostraL(&lista);

    cout << "\n#TESTE 9\n";
    insereAposCadaOcorrencia(&lista, 5, 12, 2025, Compromisso(5, 12, 2025, "CX7"));
    mostraL(&lista);

    cout << "\n#TESTE 10\n";
    insereAposCadaOcorrencia(&lista, 5, 12, 2025, Compromisso(5, 12, 2025, "CX8"));
    mostraL(&lista);


    cout << "\n#TESTE 11\n";
    insereAposCadaOcorrencia(&lista, 5, 14, 2025, Compromisso(5, 12, 2025, "CX9"));
    mostraL(&lista);

    cout << "\n#TESTE 12\n";
	insereAposPrimeiraOcorrencia(&lista, 6, 16, 2024, Compromisso(7, 12, 2025, "CX10"));
	mostraL(&lista);
	cout << "Compromisso do fim da lista: " << lista.fim->dado.descricao << endl;
